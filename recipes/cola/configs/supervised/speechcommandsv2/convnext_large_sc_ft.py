...
def get_config():
    ...
    config.model.arch = "convnext_large"
    config.model.type = "multiclass"
    config.model.num_classes = 35
    config.model.pretrained = "/home/sarthak/jax_exps/audax/cola/ssl/convnext_large_8x256_lr1e-3_wd0.005_bilinear_50eps_specaug_posonly_specfix"
